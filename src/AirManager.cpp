...
std::list<std::list<Airport>> AirManager::getTraveledAirports(const std::string &source_airport, const std::string &target_airport) {
...
void AirManager::local_coordenates(){
    ...
    std::list<std::list<Airport>> temp;
    bool flag = true;
